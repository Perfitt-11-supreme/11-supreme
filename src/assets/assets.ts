...
export {
  ...
  onboarding2, perfittlogo, picture, plus, polygon2,
  prefitt_symbol, rectangle, salomon, search,
  select, select_arrow20,
  select_arrow24, share, shoes_w159,
  shoes_w182, sidemenu_delete, sidemenu_linkshare, sidemenu_list, sidemenu_plus, small_arrow,
  speech_bubble,
  thumbs_down, tip1,
  tip2,
  tip3,
